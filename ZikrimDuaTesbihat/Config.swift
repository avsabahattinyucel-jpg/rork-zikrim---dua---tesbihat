...
// Keys are injected by CI at build time
...
enum Config {
    ...
    static let GROQ_API_BASE_URL = "https://api.groq.com/openai/v1"
    static let GROQ_API_KEY = "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"
    static let GROQ_MODEL = "llama-3.3-70b-versatile"
    static let GROQ_FALLBACK_MODEL = "llama-3.1-8b-instant"
